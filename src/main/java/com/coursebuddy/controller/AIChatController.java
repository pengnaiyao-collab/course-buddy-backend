...
public class AIChatController {
    ...
    public ApiResponse<ChatResponseVO> chat(@Valid @RequestBody ChatRequestDTO dto) {
        return ApiResponse.success(aiChatService.chat(dto));
    }
    ...
    public ApiResponse<Page<ConversationVO>> listConversations(@PageableDefault(size = 20) Pageable pageable) {
        return ApiResponse.success(aiChatService.listConversations(pageable));
    }
    ...
    public ApiResponse<List<ChatMessageVO>> getMessages(@PathVariable Long id) {
        return ApiResponse.success(aiChatService.getConversationMessages(id));
    }
    ...
    public ApiResponse<ConversationVO> archiveConversation(@PathVariable Long id) {
        return ApiResponse.success(aiChatService.archiveConversation(id));
    }
